...
function setObjs() {
  ...
  for (let i = 0; i < cntWidth * 2; i++) {
    ...
    let ran1 = Math.trunc(Math.random() * 50) + 40	  
    let ran2 = Math.trunc(Math.random() * 50) + 40	  
    let ran3 = Math.trunc(Math.random() * 50) + 40	  
    let ran4 = Math.trunc(Math.random() * 50) + 40	  
