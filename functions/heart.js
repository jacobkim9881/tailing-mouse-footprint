...
function mouseEvent(e) {
  ...
  function trigger(e, moveX) {
    ...
    halfHeart.style.backgroundColor = `hsl(0, 100%, 50%)`;
    ...
    setTimeout(() => halfHeart.remove(), 500);
    ...
    OtherHalfHeart.style.backgroundColor = `hsl(0, 100%, 50%)`;
    ...
    setTimeout(() => OtherHalfHeart.remove(), 500);
